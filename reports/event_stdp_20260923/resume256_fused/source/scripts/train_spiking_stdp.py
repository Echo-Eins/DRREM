...
def main():
    ...
    p.add_argument('--core-lr',type=float,default=.0003)
    ...
    p.add_argument('--learn-input',action='store_true')
    ...
    cfg=SpikeConfig(N=a.N,hops=a.hops,horizons=a.horizons,core_lr=a.core_lr,head_lr=a.head_lr,
        ...
        learning=a.learning,teacher_gain=a.teacher_gain,
    ...
    if a.resume:
        ck=torch.load(a.out/'checkpoint.pt',map_location=m.dev,weights_only=False)
