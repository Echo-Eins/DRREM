...
class SpikingRREM:
    ...
    def init_state(self,batch,learning=False):
        ...
        return SpikeState(self.initial_u[None].expand(batch,-1).clone(),zeros(batch,D),
    ...
    @torch.no_grad()
    def tick(self,state,byte,active,*,weights=None,input_weights=None,record=False):
        c=self.cfg
    ...
    def train_batch(self,batch):
        ...
        for t in range(b.T-1):
            ...
            out=self.tick(state,b.x[:,t],active,weights=W,input_weights=table)
